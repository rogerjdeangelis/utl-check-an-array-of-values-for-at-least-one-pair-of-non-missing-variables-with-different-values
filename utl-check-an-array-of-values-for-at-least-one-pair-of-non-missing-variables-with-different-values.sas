...
github                                                                                                                                  
https://tinyurl.com/yxejo3gp                                                                                                            
https://github.com/rogerjdeangelis/utl-check-an-array-of-values-for-at-least-one-pair-of-non-missing-variables-with-different-values    
                                                                                                                                        
SAS-L                                                                                                                                   
https://listserv.uga.edu/cgi-bin/wa?A2=SAS-L;7baa5da.1909b                                                                              
                                                                                                                                        
SASA Forum                                                                                                                              
https://tinyurl.com/yxce287q                                                                                                            
...
*             _ _     _   _            _                                                                                                
 ...
 / _ \    / _` | / __| __| | '_ \ / __| __|                                                                                             
|  __/_  | (_| | \__ \ |_| | | | | (__| |_                                                                                              
 \___(_)  \__,_|_|___/\__|_|_| |_|\___|\__|                                                                                             
                                                                                                                                        
;                                                                                                                                       
                                                                                                                                        
 EORK.TRY total obs=8                                                                                                                   
                                                                                                                                        
 ID    V1    V2    V3    UNIQUEENTRY                                                                                                    
...
Roger,                                                                                                                                  
    the title is a bit misleading, in that none of the solutions *count* the number of distinct strings                                 
(utl-count-distinct-words-in-an-array-of-words-normaliza-first)                                                                         
                                                                                                                                        
Although all could easily be modified to produce that output                                                                            
(particularly the sql which actually counts the distinct values)                                                                        
Code below is untested, but should be close to                                                                                          
counting the number of distinct string values.                                                                                          
...
Data try;                                                                                                                               
  set have;                                                                                                                             
    ...
    UniqueEntry=1;                                                                                                                      
      Do i = 1 to dim(Comp)-1;                                                                                                          
        if missing (comp{i}) then Continue; /*This line was in the wrong place in the original code*/                                   
            Do j= i+1 to dim(Comp);                                                                                                     
              if STRIP(Comp{i}) = STRIP(Comp{j}) then do;                                                                               
                  DupEntry=1;                                                                                                           
                  Leave;                                                                                                                
            end;                                                                                                                        
        end;                                                                                                                            
      if DupEntry=0 then UniqueEntry=UniqueEntry+1;                                                                                     
      DupEntry=0;                                                                                                                       
     end;                                                                                                                               
     drop i j dup:;                                                                                                                     
 run;                                                                                                                                   
